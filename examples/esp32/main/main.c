 ...
 * sets external functions for the MQTT library, creates FreeRTOS tasks
 * for sending and receiving MQTT messages, connects to an MQTT broker, and subscribes to
 * MQTT topics as well as provide examples to publish data, ping the broker and disconnect.
 */
void app_main(void)
{
